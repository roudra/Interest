...
It produces the `app-eip-1.0.0-SNAPSHOT-runner.jar` file in the `/target` directory. Be aware that it’s not an _
...
The application is now runnable using `java -jar target/app-eip-1.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./target/app-eip-1.0.0-SNAPSHOT-runner`
